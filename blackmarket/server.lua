...
RegisterServerEvent('aendir-blackmarket:GetItem', function(amount, billtype, item, shoptable, price, removeitem)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local BlackMoneyName = Config.BlackMoneyName
    ...
    if Config.RemoveItem then
        ...
        TriggerClientEvent('aendir-blackmarket:ShopMenu', src, data, custom)
    end
end)
